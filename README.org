...
#+name: plantuml2-wbs
#+BEGIN_SRC plantuml :eval no-export :exports results :file pics/jrr-menu.svg
 @startwbs
 ,* JRR
 ,**:== [[../pics-keep/screenshots/jrr-01-radio-stream.png Radio]]
 ==Näyttökentät==
,* Radiokanavan nimi
,* Radiokanavan ikoni
 ==Näppäin 1==
...
[[file:pics-keep/screenshots/jrr-01-radio-stream.png]]

** 2 - Asetukset

*** 2.1 - Poista kanavia

[[file:pics-keep/screenshots/jrr-02-setup-main-Poista.png]]


*** 2.2 - Lisää kanavia

[[file:pics-keep/screenshots/jrr-02-setup-main-Lisää kanavia.png]]

*** 2.3 - Valitse Wifi -verkko

[[file:pics-keep/screenshots/jrr-02-setup-main-Wifi.png]]

*** 2.4 - Asetukset näppämistöllä

[[file:pics-keep/screenshots/jrr-02-setup-main-Näppis.png]]

**** 2.4.1 - Wifi asetukset

[[file:pics-keep/screenshots/jrr-03-keyboard-config-Wifi.png]]

[[file:pics-keep/screenshots/jrr-04-wifi-setup-wifi-setup.png]]

**** 2.4.2 - Radiokanavahakemiston asetukset

[[file:pics-keep/screenshots/jrr-03-keyboard-config-Hakemisto.png]]


[[file:pics-keep/screenshots/jrr-03-channel-origin-channel-setup.png]]

**** 2.4.x - Näytön kierto

[[file:pics-keep/screenshots/jrr-03-keyboard-config-Näytön kierto.png]]


*** 2.5. - Päivitä ohjelmistoversio

[[file:pics-keep/screenshots/jrr-02-setup-main-Ohjelmaversio.png]]

*** 2.6. - Uudelleenkäynnistys

[[file:pics-keep/screenshots/jrr-02-setup-main-Reboot.png]]

* Ohjelmistoversion palautus tehdasasetuksiin

- Paina molemmat painonapit alas ennen virtojen kytkemistä ja kytke virta radioon.
...
Modified:2026-04-28.19:36; # time-stamp
